...
import { getEmployeeCourseById } from 'apiSdk/employee-courses';
...
function EmployeeCourseViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Employee Course Detail View
          </Text>
          {hasAccess('employee_course', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/employee-courses/edit/${data?.id}`} passHref legacyBehavior>
              <Button
